...
// {
// org.bmsource.ws.client.CreditCard creditCard = new
// org.bmsource.ws.client.CreditCard();
...
// // TextMessage message = session.createTextMessage("Text message sent at " +
// new Date());
...
// ctx.lookup("java:global/blog/BookEJB!org.bmsource.beans.BookEJBRemote");
